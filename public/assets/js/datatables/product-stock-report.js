  ...
  table8 = $("#dt-unit-transfers").DataTable({
    ajax: {
      ...
      data: function (params) {
        ...
        params.date_range_column = "transfer_date";
        params.date_from = $("#unit-transfers-tab #date-from").val();
        params.date_to = $("#unit-transfers-tab #date-to").val();
  ...
  table6 = $("#dt-adjustments").DataTable({
    ajax: {
      ...
      data: function (params) {
        ...
        params.date_range_column = "adj_date";
        params.date_from = $("#adjustments-tab #date-from").val();
        params.date_to = $("#adjustments-tab #date-to").val();
  ...
  table5 = $("#dt-transfers").DataTable({
    ajax: {
      ...
      data: function (params) {
        ...
        params.fields = filter;
        params.date_range_column = "transfer_date";
        params.date_from = $("#transfers-tab #date-from").val();
        params.date_to = $("#transfers-tab #date-to").val();
  ...
  table3 = $("#dt-sales-returns").DataTable({
    ajax: {
      ...
      data: function (params) {
        ...
        params.date_from = $("#sales-returns-tab #date-from").val();
        params.date_to = $("#sales-returns-tab #date-to").val();
  ...
  table4 = $("#dt-purchase-returns").DataTable({
    ajax: {
      ...
      data: function (params) {
        ...
        params.fields = filter;
        params.date_range_column = "return_date";
        params.date_from = $("#purchase-returns-tab #date-from").val();
        params.date_to = $("#purchase-returns-tab #date-to").val();
  ...
  tableSale = $("#dt-sales").DataTable({
    ajax: {
      ...
      data: function (params) {
        ...
        params.date_from = $("#sales-tab #date-from").val();
        params.date_to = $("#sales-tab #date-to").val();
  ...
  tablePurchase = $("#dt-purchases").DataTable({
    ajax: {
      ...
      data: function (params) {
        ...
        params.date_from = $("#purchases-tab #date-from").val();
        params.date_to = $("#purchases-tab #date-to").val();
