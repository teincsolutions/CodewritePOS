...
$(function () {
  table = $("#dt-sales-report").DataTable({
    ajax: {
      url: baseUrl + "/daily-sales/datatable",
      dataType: "json",
      ...
      data: function (params) {
        ...
        params['sales.store_id'] = $('.select2-store').val();
    ...
    columns: [
      ...
      },
      {
        ...
        render: function (data) {
          return ` ${(
            parseFloat(data.total_cash_sales) +
            parseFloat(data.total_momo_sales)
          ).toFixed(2)}`;
        },
      },
      {
    ...
    footerCallback: function (row, data, start, end, display) {
      ...
      pageTotal = api
        ...
        .reduce(function (a, b) {
          return (
            intVal(a) + intVal(b.total_cash_sales) + intVal(b.total_momo_sales)
          );
        }, 0);
