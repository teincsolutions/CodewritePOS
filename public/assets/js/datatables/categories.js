...
$(function () {
  table = $("#dt-categories").DataTable({
    ajax: {
      url: baseUrl + "/categories/datatable",
      dataType: "json",
      ...
      { data: "user_id", name: "categories.user_id" },
      {
        ...
        render: function (data, type, row) {
          if (type === "display") {
            ...
            }}, '${baseUrl}/categories')" class="check">
                        <label for="user${
                          row.id
                        }" class="checktoggle">checkbox</label>
                        </div>
                        <a class="me-3 text-secondary" href="${baseUrl}/categories/edit/${
              row.id
            }"><i class="fa fa-edit fa-lg"></i></a>
                        <a class="text-danger" href="javascript:void(0);" onclick="deleteRow(table, ${
                          row.id
                        }, '${baseUrl}/categories')"><i class="fa fa-trash fa-lg"></i></a>
                    </div>`;
          }
          return data;
        },
