...
$(function () {
  table = $("#dt-returns").DataTable({
    ...
    columns: [
      ...
      {
        data: "settlement",
        name: "container_receivings.settlement",
        render: function (data, type) {
          if (type === "display") {
            const badges = {
              cash: "bg-lightgreen",
        ...
        render: function (data, type, row) {
          if (type === "display") {
            return `<div class="d-flex align-items-center">
                        <a target="_blank" href="${baseUrl}container/receivings/${data}" class="me-3"><i class="fa fa-eye fa-lg"></i></a>
                        <a ${
                          row.order_status === "completed"
                            ? Settings.AllowDeleteContainersReceivings === "yes"
                              ? ""
                              : "hidden"
                            : ""
                        } class="text-danger" href="javascript:void(0);" onclick="deleteRow(table, ${data}, '${baseUrl}containers/receivings')"><i class="fa fa-trash fa-lg"></i></a>
                    </div>`;
          }
          return data;
        },
