...
$(function () {
  table = $("#dt-returns").DataTable({
    ajax: {
      url: baseUrl + "containers/returns/datatable",
      dataType: "json",
    ...
    columns: [
      ...
      { data: "return_date", name: "containers_returns.return_date" },
      {
        data: "container",
        name: "containers.customer_id",
        render: function (data, type, row) {
          if (type === "display")
      ...
      { data: "invoice", name: "containers_returns.invoice" },
      {
        data: "order_status",
        name: "containers_returns.order_status",
      ...
      {
        data: "payment_status",
        name: "containers_returns.payment_status",
        render: function (data, type) {
          if (type === "display") {
            const badges = {
              paid: "bg-lightgreen",
      ...
      {
        data: "user",
        name: "containers_returns.user_id",
        render: function (data, type, row) {
          if (type === "display")
    ...
    footerCallback: function (row, data, start, end, display) {
      ...
      // Update footer
      $(api.column(8).footer()).html("GHS " + pageTotal.toFixed(2));
    },
    order: [[3, "desc"]],
    columnDefs: [
      {
