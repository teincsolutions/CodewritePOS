...
const searchParams = {
  columns: [
    ...
    {
      name: "concat(containers.name,' ',categories.name)",
      searchable: "true",
    },
    {
      name: "concat(containers.name,' ',brands.name)",
      searchable: "true",
    },
    {
...
function autocomplete(inp) {
  ...
  inp.addEventListener("input", function (e) {
    ...
    if (Settings.ContainerDiffForStore === "yes")
        ...
        d.data.forEach((item, i) => {
          ...
          b.addEventListener("click", function (e) {
            ...
            let row = ` <tr>
                                        ...
                                        <td class="containerimgname">
                                        ${
                                          item.image_uri
                                            ? `<a class="container-img"><img src="${baseUrl}${item.image_uri}" alt="container"></a>`
                                            : '<a class="p-3"></a>'
                                        }
