...
<div class="content">
    <div class="page-header">
        <div class="page-title">
            ...
            <h6>Manage your containers</h6>
        </div>
        <div class="page-btn">
            <a href="<?= site_url('containers/create') ?>" class="btn btn-added"><i class="fa fa-plus" class="me-1"></i> New Container</a>
        </div>
    </div>
            ...
            <div class="card mb-0" id="filter_inputs">
                <div class="card-body pb-0">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="form-group">
                                <input name="name" type="text" placeholder="Enter Container Name">
                            </div>
                        </div>
...
<script src="<?= base_url('assets/js/datatables/containers.js?v=1') ?>"></script>
<?= $this->endSection() ?>