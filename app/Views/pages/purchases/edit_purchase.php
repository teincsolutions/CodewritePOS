        ...
        <div class="row">
                                                ...
                                                <td>
                                                    <div class="increment-decrement">
                                                        <div class="input-groups">
                                                            ...
                                                            <input onkeyup="updateItemRow(this)" min=".1" type="text" name="items[<?= $key ?>][qty]" value="<?= $row->qty ?>" class="quantity-field rqty" required>
            ...
            <div class="col-lg-4 col-sm-12 ">
                <div class="order-list">
                    <div class="orderid">
                        <h5>Transaction id : <span id="order-id"><?= isset($purchase) ? $purchase->invoice : $invoice; ?></span></h5>
                    </div>
...
<?= $this->section('script') ?>
<script src="<?= base_url('assets/js/handle-order.js?v=24') ?>"></script>
<script src="<?= base_url('assets/js/datatables/order.modal.js?v=2') ?>"></script>
