...
<div class="content">
    <div class="page-header">
        <div class="page-title">
            <h4>Edit Purchase Items - <?= isset($purchase) ? $purchase->invoice : '' ?></h4>
            <h6>Edit items for purchase <?= isset($purchase) ? $purchase->invoice : '' ?></h6>
        </div>
        <div class="page-btn">
            <a href="<?= site_url('purchases') ?>" class="btn btn-secondary"><i class="fa fa-arrow-left"></i> Back</a>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form id="editItemsForm" action="<?= site_url('purchases/items/save') ?>" method="POST">
                <?= csrf_field() ?>
                ...
                <div class="mt-3">
                    <a href="<?= site_url('purchases') ?>" class="btn btn-secondary"><i class="fa fa-arrow-left"></i> Cancel</a>
