    ...
    <div class="card">
        <div class="card-body">
            <div class="card-purchases-split">
                <h2>Purchase Detail : <?= $purchase->invoice; ?></h2>
                <ul>
                    <li>
                    </li>
                </ul>
                        ...
                        <tr>
                            <td colspan="4" style="padding:5px;vertical-align:top;text-align:left;padding-bottom:20px;width:100%;">
                                <div>
                                    ...
                                    <font style="vertical-align: inherit;">
                                        Address: <font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;"><?= $purchase->supplier ? $purchase->supplier->address : null ?></font>
                                    </font><br>
                                    <font style="vertical-align: inherit;">
                                        Biller: <font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                            <?= $purchase->user->firstname; ?> <?= $purchase->user->lastname; ?></font>
                                    </font>
                                </div>
                            </td>
