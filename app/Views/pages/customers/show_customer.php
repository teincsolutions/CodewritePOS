            ...
            <div class="card bg-white">
                ...
                <div class="card-body">
                    <ul class="nav nav-tabs nav-justified">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#containers-tab" data-bs-toggle="tab">Container Account</a></li>
                            ...
                            <div class="row mt-5">
                                <div class="col-md-12">
                                    <div class="card" id="filter_inputs4">
                                        <div class="card-body pb-0">
                                            <div class="row">
                                                <input type="hidden" name="customer_containers.customer_id" value="<?= $customer->id; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="table-responsive">
...
<script src="<?= base_url('assets/js/customer-details.js?v=23') ?>"></script>
<script src="<?= base_url('assets/js/datatables/customer-containers.js?v=1') ?>"></script>
<?= $this->endSection() ?>