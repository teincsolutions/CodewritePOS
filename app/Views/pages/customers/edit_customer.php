    ...
    <form action="<?= site_url('customers') ?>" class="card post-form" method="post">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <?php if (!isset($customer) && auth()->user()->can('customer-ledgers.edit-debit')) : ?>
                    <div class="row">
                        <div class="col-lg-3 col-12">
                            <div class="form-group">
                                <label>Initial Balance</label>
                                <div class="input-group">
                                    <input type="number" name="initial_balance" class="form-control" placeholder="Customer Balance" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-12">
