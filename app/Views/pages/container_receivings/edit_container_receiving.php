...
<div class="content">
    <div class="page-header">
        ...
        <div class="page-btn">
            <a href="<?= site_url('container/receivings') ?>" class="btn btn-added"><i class="fa fa-arrow-left me-1"></i> List Receivings</a>
        </div>
    </div>
    <form class="post-form" action="<?= site_url('containers/receivings') ?>" method="post">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="offset-lg-6 col-lg-3 col-sm-6 col-12">
                        <div class="form-group">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="form-group">
                            <label>Paid</label>
                            <input onkeyup="updateTotals()" onchange="updateTotals()" type="number" name="paid" id="paid" value="0" class="form-control" placeholder="Paid Amount" readonly>
                        </div>
                    </div>
                </div>
                <div class="row">
...
<?= $this->endSection() ?>
<?= $this->section('script') ?>
<script src="<?= base_url('assets/js/handle-container-receivings.js?v=2') ?>"></script>
<?= $this->endSection() ?>