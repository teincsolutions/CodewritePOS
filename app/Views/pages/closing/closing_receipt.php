...
<style>
    ...
    * {
    ...
    body[data-theme=dark] .chat-cont-left .chat-scroll .media .media-body .user-name,
    body[data-theme=dark] .chat-cont-left .chat-scroll .media .media-body .user-last-chat {
        color: #97A2D2;
    }
    ...
    body[data-theme=dark] .image-upload-new .productviewscontent .productviewsname h2,
    body[data-theme=dark] .image-upload-new .productviewscontent .productviewsname h3 {
        color: #8ea0af;
    }
    ...
    body[data-theme=dark] .select2-container--focus .select2-selection--single::placeholder,
    ...
    body[data-theme=dark] .product-list ul li .productviews .productviewscontent .productviewsname h2,
    body[data-theme=dark] .product-list ul li .productviews .productviewscontent .productviewsname h3 {
        color: #97A2D2;
    }
    ...
    body[data-theme=dark] .bs-popover-auto[data-popper-placement^=top]>.popover-arrow::after,
    ...
    body[data-theme=dark] .sidebar.side-three.new-header .sidebar-menu>ul>li>a img,
    body[data-theme=dark] .sidebar.side-three.new-header .sidebar-menu>ul>li>a svg {
        filter: brightness(0) saturate(100%) invert(65%) sepia(27%) saturate(206%) hue-rotate(165deg) brightness(93%) contrast(88%);
    }
...
<div id="invoice-POS">
    <center id="top">
        <div class="info">
            <h2 class="text-uppercase">Closing Report <br><?= date('l,jS M Y h:i A', strtotime($report->created_at)); ?></h2>
        </div>
    ...
    <div class="productdetails">
        <ul class="product-bar">
            <li>
                <h4> <strong>Issued By : </strong><span><?= $report->user ? $report->user->firstname : ''; ?> <?= $report->user ? $report->user->lastname : ''; ?></span></h4>
                <h6><strong>Contact : </strong><span><?= $report->user->phone ?? ''; ?></span></h6>
            </li>
            <li>
                <h4><strong>Approved By : </strong><span><?= $report->approvalUser->firstname ?? ''; ?> <?= $report->approvalUser->lastname ?? ''; ?></span></h4>
                <h6> <strong>Contact : </strong><span><?= $report->approvalUser->phone ?? ''; ?></span></h6>
            </li>
        </ul>
    </div>
    <div class="row">
            ...
            <div class="productdetails">
                <ul class="product-bar">
                    <li>
                        ...
                        <h6>GHS <?= $report->opening_balance < 0 ? "(" . number_format(abs($report->opening_balance), 2) . ")" : number_format($report->opening_balance, 2) ?></h6>
                    </li>
                    <li>
                        <h4>Cashup</h4>
                        <h6>GHS <?= number_format($report->cashup, 2) ?></h6>
                    </li>
                    <li>
                        <h4>Customer Debt Payments</h4>
                        <h6>GHS <?= number_format($report->customer_payment, 2) ?></h6>
                    </li>
                    <li>
                        <h4>Total Sales</h4>
                        <h6>GHS <?= number_format($report->sale_total, 2) ?></h6>
                    </li>
                    <li>
                        <h4>Total Purchase Return</h4>
                        <h6>GHS <?= number_format($report->purchase_return_total, 2) ?></h6>
                    </li>
                    <li>
                        <h4>Transfer Payment</h4>
                        <h6>GHS <?= number_format($report->product_transfer_balance, 2) ?></h6>
                    </li>
                </ul>
            </div>
        </div>
        <div class="col-md-6">
            ...
            <div class="productdetails">
                <ul class="product-bar">
                    <li>
                        <h4>Cash in Hand</h4>
                        <h6>GHS <?= number_format($report->cash_in_hand, 2) ?></h6>
                    </li>
                    <li>
                        <h4>Supplier Payment</h4>
                        <h6>GHS <?= number_format($report->supplier_payment, 2) ?></h6>
                    </li>
                    <li>
                        <h4>Total Sale Returns</h4>
                        <h6>GHS <?= number_format($report->sale_return_total, 2) ?></h6>
                    </li>

                    <li>
                        <h4>Total Expenses</h4>
                        <h6>GHS <?= number_format($report->expense_total, 2) ?></h6>
                    </li>
                    <li>
                        <h4>Avaliable Balance</h4>
                        <h6>GHS <?= ($report->closing_balance + $report->cash_in_hand) < 0 ? "(" . number_format(abs($report->closing_balance), 2) . ")" : number_format($report->closing_balance + $report->cash_in_hand, 2) ?></h6>
                    </li>
                    <li>
                        <h4>Closing Balance</h4>
                        <h6>GHS <?= $report->closing_balance < 0 ? "(" . number_format(abs($report->closing_balance), 2) . ")" : number_format($report->closing_balance, 2) ?></h6>
                    </li>
                </ul>
            </div>
