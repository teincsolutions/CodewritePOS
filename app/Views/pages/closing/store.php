                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-6 border-end">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="sale_total">Total Containers Sold</label>
                                    <input type="number" name="container_sale_total" value="<?= isset($closing) ? $closing->container_sale_total : number_format($container_sale_total ?? 0, 2, '.', '') ?>" class="form-control" readonly required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
...
<script>
    function updateClosing() {
        ...
        let openingBalance = intVal($("[name='opening_balance']").val()),
            ...
            containerSaleTotal = intVal($("[name='container_sale_total']").val()),
            purchaseReturnTotal = intVal($("[name='purchase_return_total']").val()),
            totalInflows = openingBalance + productTransferBalance + cashup + customerPayment + saleTotal + containerSaleTotal;
