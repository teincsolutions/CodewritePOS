    ...
    <div class="card">
        <div class="card-body">
            <div class="card-purchases-split">
                <h2>Purchase Return Detail : <?= $return->invoice; ?></h2>
                <ul>
                    <li>
                    </li>
                </ul>
                            ...
                            <td colspan="6" style="padding:5px;vertical-align:top;text-align:left;padding-bottom:20px;width:100%; text-align:center">
                                ...
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                        <h1><?= $return->purchase->store->name; ?></h1>
                                    </font>
                                </font><br>
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                        <?= $return->purchase->store->location; ?></font>
                                </font><br>
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                        <?= $return->purchase->store->description; ?></font>
                                </font>
                            </td>
                        </tr>
                        <tr>
                                ...
                                <div>
                                    ...
                                    <font style="vertical-align: inherit;">
                                        Name: <font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                            <?= $return->purchase->supplier ? $return->purchase->supplier->name : 'walk-in-supplier' ?></font>
                                    </font><br>
                                    <font style="vertical-align: inherit;">
                                        Email: <font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                            <a href="<?= $return->purchase->supplier ? $return->purchase->supplier->email : null ?>" class="__cf_email__"><?= $return->purchase->supplier ? $return->purchase->supplier->email : null ?></a>
                                        </font>
                                    </font><br>
                                    <font style="vertical-align: inherit;">
                                       Phone:  <font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                            <?= $return->purchase->supplier ? $return->purchase->supplier->phone : null ?></font>
                                    </font><br>
                                    <font style="vertical-align: inherit;">
                                        Address: <font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;"><?= $return->purchase->supplier ? $return->purchase->supplier->address : null ?></font>
                                    </font><br>
                                    <font style="vertical-align: inherit;">
                                        Biller: <font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                            <?= $return->user->firstname; ?> <?= $return->user->lastname; ?></font>
                                    </font>
                                </div>
                            </td>
                                ...
                                <div style="width: 150px;">
                                    ...
                                    <font style="vertical-align: inherit;">
                                        <font class="text-capitalize" style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                            <?= date('d/m/y h:i a', strtotime($return->created_at)); ?></font>
                                    </font>
                                </div>
                            </td>
                        </tr>
            ...
            <div class="row">
                    ...
                    <div class="col-lg-6 ">
                        <div class="total-order w-100 max-widthauto m-auto mb-4">
                            <ul>
                                <li>
                                    <h4>Order Tax</h4>
                                    <h5 class="orderTaxes"><?= $return->tax; ?>%</h5>
                                </li>
                                <li>
                                    <h4>Discount </h4>
                                    <h5 class="discountTotal"> <?= $return->discount; ?></h5>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6 ">
                        <div class="total-order w-100 max-widthauto m-auto mb-4">
                            <ul>
                                <li>
                                    <h4>Shipping</h4>
                                    <h5 class="shippingTotal"><?= number_format($return->shipping, 2); ?></h5>
                                </li>
                                <li class="total">
                                    <h4>Grand Total</h4>
                                    <h5 class="grandTotal">GHS <?= number_format($return->total_amount, 2) ?></h5>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <a onclick="rePrintInvoice('<?= site_url('print/purchases/returns/' . $return->id) ?>')" href="javascript:void(0);" class="btn btn-submit me-2">Print Invoice</a>
                </div>
            </div>
        </div>
    </div>
