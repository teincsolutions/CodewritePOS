...
<div class="content">
    <div class="page-header">
        <div class="page-title">
            <h4>Containers Return List</h4>
            <h6>Manage your Returns</h6>
        </div>
        <div class="page-btn">
            <a href="<?= site_url('containers/returns/create') ?>" class="btn btn-added"><i class="fa fa-plus" class="me-3"></i>New Container Return</a>
        </div>
    </div>
...
<script src="<?= base_url('assets/js/datatables/container-returns.js?v=7') ?>"></script>
<?= $this->endSection() ?>