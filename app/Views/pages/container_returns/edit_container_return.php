                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <select name="container_id" class="select2-invoices" required>
                                <option value=""></option>
                                <?php if (isset($container)) : ?>
                                    <option value="<?= $container->id ?>" selected><?= $container->invoice ?> (<?= isset($container->supplier) ? $container->supplier->name : 'walk-in-supplier' ?> - GHS <?= $container->total_amount; ?>)</option>
                                <?php endif ?>
                            </select>
                        </div>
                    </div>
                                            ...
                                            <td>
                                                <div class="increment-decrement">
                                                    <div class="input-groups">
                                                        ...
                                                        <input type='hidden' name="items[<?= $key ?>][container_item_id]" value="<?= $row->id ?>">
...
<?= $this->endSection() ?>
<?= $this->section('script') ?>
<script src="<?= base_url('assets/js/handle-container-return.js?v=3') ?>"></script>
