...
<div class="content">
    <div class="page-header">
        ...
        <div class="page-btn">
            <a href="<?= site_url('container/returns') ?>" class="btn btn-added"><i class="fa fa-arrow-left me-1"></i> List Container Returns</a>
        </div>
    </div>
    <form class="post-form" action="<?= site_url('containers/returns') ?>" method="post">
        ...
        <input id="returns-total" type="hidden" name="total_amount" value="">
        <input id="total-paid" type="hidden" name="paid" value="">
        <div class="card">
            <div class="card-body">
                <div class="row">
                </div>
