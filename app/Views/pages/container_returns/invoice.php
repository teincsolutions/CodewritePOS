...
<div class="content">
    <div class="page-header">
        <div class="page-title">
            <h4>Container Return Details</h4>
    ...
    <div class="card">
        <div class="card-body">
                        ...
                        <tr>
                            <td colspan="4" style="padding:5px;vertical-align:top;text-align:left;padding-bottom:20px;width:100%;">
                                <div>
                                    ...
                                    <font style="vertical-align: inherit;">
                                        <font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                            <?= $return->supplier ? $return->supplier->name : 'walk-in-supplier' ?></font>
                                    </font><br>
                                    <font style="vertical-align: inherit;">
                                        <font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                            <a href="<?= $return->supplier ? $return->supplier->email : null ?>" class="__cf_email__"><?= $return->supplier ? $return->supplier->email : null ?></a>
                                        </font>
                                    </font><br>
                                    <font style="vertical-align: inherit;">
                                        <font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                            <?= $return->supplier ? $return->supplier->phone : null ?></font>
                                    </font><br>
                                    <font style="vertical-align: inherit;">
                                        <font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;"><?= $return->supplier ? $return->supplier->address : null ?></font>
                                    </font>
                                </div>
                            </td>
                    ...
                    <tbody>
                        ...
                        if (isset($return))
                            ...
                            <tr class="details" style="border-bottom:1px solid #E9ECEF;">
                                ...
                                <td style="padding: 5px;vertical-align: middle;font-weight: 600;color: #5E5873;font-size: 14px;padding: 10px; "><?= number_format($row->unit_cost * $row->qty, 2) ?></td>
                            </tr>
                        <?php endforeach ?>
                    </tbody>
                </table>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <a onclick="rePrintInvoice('<?= site_url('print/containers/returns/' . $return->id) ?>')" href="javascript:void(0);" class="btn btn-submit me-2">Print Invoice</a>
                </div>
            </div>
        </div>
    </div>
