...
<div class="content">
    <div class="page-header">
        <div class="page-title">
            ...
            <h6>View container details</h6>
        </div>
    </div>
    <div class="card">
        <div class="card-body">
            <div class="card-containers-split">
                <h2>Container Return Detail : INV<?= $return->invoice; ?></h2>
                <ul>
                    <li>
                    </li>
                </ul>
                            ...
                            <td colspan="6" style="padding:5px;vertical-align:top;text-align:left;padding-bottom:20px;width:100%; text-align:center">
                                ...
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                        <h1><?= $return->container->store->name; ?></h1>
                                    </font>
                                </font><br>
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                        <?= $return->container->store->location; ?></font>
                                </font><br>
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                        <?= $return->container->store->description; ?></font>
                                </font>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4" style="padding:5px;vertical-align:top;text-align:left;padding-bottom:20px;width:100%;">
                                <div>
                                    ...
                                    <font style="vertical-align: inherit;">
                                        <font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                            <?= $return->container->supplier ? $return->container->supplier->name : 'walk-in-supplier' ?></font>
                                    </font><br>
                                    <font style="vertical-align: inherit;">
                                        <font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                            <a href="<?= $return->container->supplier ? $return->container->supplier->email : null ?>" class="__cf_email__"><?= $return->container->supplier ? $return->container->supplier->email : null ?></a>
                                        </font>
                                    </font><br>
                                    <font style="vertical-align: inherit;">
                                        <font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                            <?= $return->container->supplier ? $return->container->supplier->phone : null ?></font>
                                    </font><br>
                                    <font style="vertical-align: inherit;">
                                        <font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;"><?= $return->container->supplier ? $return->container->supplier->address : null ?></font>
                                    </font>
                                </div>
                            </td>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <a href="<?= site_url('containers/returns/create?invoice=' . $return->invoice) ?>" class="btn btn-submit me-2">Return</a>
                </div>
            </div>
        </div>
    </div>
