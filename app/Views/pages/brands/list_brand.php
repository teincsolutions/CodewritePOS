...
<div class="content">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form class="card" id="filter_inputs">
                <div class="card-body pb-0">
                    <div class="row">
                        ...
                        <div class="col-lg-1 col-sm-6 col-12 ms-auto">
                            <div class="form-group">
                                <a class="btn btn-filters ms-auto filter"><img src="https://dreamspos.dreamguystech.com/html/template/assets/img/icons/search-whites.svg" alt="img"></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="table-responsive">
                <table id="dt-brands" class="table">
                    <thead>
                        <tr>
                            <th>
...
<script src="<?= base_url('assets/js/datatables/brands.js') ?>"></script>
<?= $this->endSection() ?>