                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <label>Action</label>
                                    <button onclick="submitReset()" type="button" class="btn btn-danger me-3 text-uppercase">Submit Reset</button>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 d-flex justify-content-end">
                                <button id="submit" onclick="$('.post-form').submit()" type="button" class="btn btn-success text-uppercase">Submit Adjustments</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<?= $this->section('script') ?>
<script src="<?= base_url('assets/js/handle-adjustment.js?v=28') ?>"></script>
