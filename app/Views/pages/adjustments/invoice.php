    ...
    <div id="invoice" class="card">
        <div class="card-body">
            <div class="card-adjustments-split">
                <h2>Adjustment Detail : <?= $adjustment->invoice; ?></h2>
                <ul>
                    <li>
                    </li>
                </ul>
                        ...
                        <tr>
                            ...
                            <td style="padding:5px;vertical-align:top;text-align:right;padding-bottom:20px;width:calc(25%)">
                                <div style="width: 150px;">
                                    ...
                                    <font style="vertical-align: inherit;">
                                        <font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                            <?= $adjustment->invoice; ?> </font>
                                    </font><br>
                                    <font style="vertical-align: inherit;">
                                        <font class="text-capitalize" style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                            <?= date('d/m/y h:i a', strtotime($adjustment->created_at)); ?></font>
                                    </font><br>
                                    <font style="vertical-align: inherit;">
                                        <font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                            <?= $adjustment->user->firstname; ?> <?= $adjustment->user->lastname; ?></font>
                                    </font>
                                </div>
                            </td>
                        </tr>
