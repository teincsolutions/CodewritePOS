...
<div class="content">
    <div class="page-header">
        ...
        <div class="page-btn">
            <a href="<?= site_url('container-adjustments') ?>" class="btn btn-added"><i class="fa fa-arrow-left me-3"></i> List Container Adjustment</a>
        </div>
    </div>
    <form class="post-form" action="<?= site_url('container-adjustments') ?>" method="post">
...
<?= $this->section('script') ?>
<script src="<?= base_url('assets/js/handle-container-adjustment.js?v=8') ?>"></script>
