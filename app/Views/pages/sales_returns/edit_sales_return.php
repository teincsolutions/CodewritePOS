                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="increment-decrement">
                                                    <div class="input-groups">
                                                        ...
                                                        <input type="hidden" name="items[<?= $key ?>][tax]" value="<?= $row->tax ?>">
                                                        ...
                                                        <input type="hidden" name="items[<?= $key ?>][subtotal]" value="<?= $row->unit_price * $row->max_qty + ($row->unit_price * $row->tax * $row->max_qty) - ($row->discount * $row->max_qty) ?>" class="rsubtotal">
                                            ...
                                            <td><?= number_format($row->unit_price * $row->max_qty - ($row->discount * $row->max_qty), 2, '.', '') ?></td>
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="tax_amounts" value="<?= isset($sales) ? $sales->tax : null ?>" class="form-control" placeholder="Sales taxes" readonly>
...
<?= $this->endSection() ?>
<?= $this->section('script') ?>
<script src="<?= base_url('assets/js/handle-sale-return.js?v=26') ?>"></script>
