                ...
                <div class="row">
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <div class="input-groupicon">
                                <input type="text" placeholder="Choose Date" name="expense_date" class="datetimepicker" value="<?= isset($expense) ? date('d-m-Y',strtotime($expense->expense_date)) : date('d-m-Y', time()) ?>">
                                <div class="addonset">
                        ...
                        <div class="form-group">
                            ...
                            <select class="select2-store" name="store_id" required>
                                ...
                                if (isset($stores))
                                    ...
                                    <option value="<?= $row->id ?>" <?= isset($expense) ? ($row->id === $expense->store_id ? 'selected' : '') : null ?>>
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <select class="select2-category" name="expense_category_id" required>
                                <option value=""></option>
                                <?php
                                if (isset($categories) && isset($expense))
                                    foreach ($categories as $row) { ?>
                                    <option value="<?= $row->id ?>" <?= $row->id === $expense->expense_category_id ? 'selected' : '' ?>><?= $row->label; ?></option>
                                    <?php }
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            <label>Expense SubCategory(Optional)</label>
                            <select class="select2-subcategory" name="expense_subcategory_id">
                                <option value=""></option>
                                <?php
                                if (isset($subcategories) && isset($expense))
                                    foreach ($subcategories as $row) { ?>
                                    <option value="<?= $row->id ?>" <?= $row->id === $expense->expense_subcategory_id ? 'selected' : '' ?>><?= $row->label; ?></option>
                                    <?php }
