...
<div class="content">
    <div class="page-header">
        <div class="page-title">
            <h4>Expense SubCategory list</h4>
            <h6>View/Search Expense SubCategory</h6>
        </div>
        <div class="page-btn">
            <a href="<?=site_url("expenses/subcategories/create");?>" class="btn btn-added">
               <i class="fa fa-plus fa-lg me-1"></i>Add SubCategory
            </a>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table" id="expensecategoriestable">
                    <thead>
                        <tr>
                            <th>
                            </th>
...
<script src="<?= base_url('assets/js/datatables/expense_subcategories.js') ?>"></script>
<?= $this->endSection() ?>