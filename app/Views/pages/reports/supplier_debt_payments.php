...
<div class="content">
    <div class="page-header">
        <div class="page-title">
            ...
            <h6>Supplier debt payment reports</h6>
        </div>
    </div>
                ...
                <div class="card-body pb-0">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-6 col-12" style="overflow-x: auto;">
                            <div class="form-group">
                                <select name="supplier_ledgers.store_id" class="select2-store">
                                    <?php
                                    if (isset($stores))
                        ...
                        <div class="col-lg-4 col-sm-6 col-12" style="overflow-x: auto;">
                            <div class="form-group">
                                <select name="supplier_ledgers.supplier_id" class="select2-supplier">
                                    <option value=""></option>
                                </select>
                            </div>
                        </div>
...
<?= $this->section('script') ?>
<script src="<?= base_url('assets/js/datatables/supplier-debt-payment-report.js?v=9') ?>"></script>
<?= $this->endSection() ?>