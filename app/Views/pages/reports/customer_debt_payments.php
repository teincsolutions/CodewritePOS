...
<div class="content">
    <div class="page-header">
        <div class="page-title">
            ...
            <h6>Customer debt payment reports</h6>
        </div>
    </div>
                ...
                <div class="card-body pb-0">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-sm-6 col-12">
                            <div class="form-group">
                                <select name="customer_ledgers.store_id" class="select2-store">
                                    <?php
                                    if (isset($stores))
...
<?= $this->section('script') ?>
<script src="<?= base_url('assets/js/datatables/customer-debt-payment-report.js?v=10') ?>"></script>
<?= $this->endSection() ?>