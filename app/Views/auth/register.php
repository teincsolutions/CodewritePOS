        ...
        <div class="card-body">
            ...
            <form class="row" action="<?= url_to('register') ?>" method="post">
                ...
                <div class="mb-4 col-md-6">
                    <input type="text" class="form-control" name="firstname" inputmode="text" autocomplete="firstname" placeholder="First Name" value="<?= old('firstname') ?>" required />
                </div>
                <!-- LastName -->
                <div class="mb-4 col-md-6">
                    <input type="text" class="form-control" name="lastname" inputmode="text" autocomplete="lastname" placeholder="Last Name" value="<?= old('lastname') ?>" required />
                </div>

                <!-- Phone -->
                <div class="mb-4">
                    <input type="text" class="form-control" name="phone" inputmode="text" autocomplete="phone" placeholder="Phone Number" value="<?= old('phone') ?>" required />
                </div>
                <!-- Email -->
                <div class="mb-4">
