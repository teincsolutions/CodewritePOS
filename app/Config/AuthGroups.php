...
class AuthGroups extends ShieldAuthGroups
{
    ...
    public array $permissions = [
        ...
        'sales.edit'          => 'Can edit sale product prices',
        ...
        'closing.report'        => 'Can access closing report',

        'cashup.view'           => 'Can view cashup',
        'cashup.create'           => 'Can create cashup',
        'cashup.delete'           => 'Can delte cashup',

        'taxes.view'        => 'Can view taxes',
        'taxes.create'        => 'Can add new taxes',
        'taxes.edit'          => 'Can edit taxes',
        'taxes.delete'        => 'Can delete existing taxes',
        'taxes.report'        => 'Can access taxes reports',
        ...
        'tax-settings.access'      => 'Can view and edit the payment settings',
    ...
    public array $matrix = [
        'admin' => [
            ...
            'sms-settings.*', 'cashup.*','preference-settings.*','tax-settings.*','taxes.*',
        ],
        'developer' => [
            'users.*', 'customers.*', 'suppliers.*', 'stores.*', 'products.*', 'brands.*',
            'categories.*', 'units.*', 'product-transfers.*', 'unit-transfers.*', 'expense-categories.*',
            ...
            'preference-settings.*','tax-settings.*','taxes.*',
        ],
        'guest' => [
