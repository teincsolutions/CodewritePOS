...
$routes->get('expenses/categories', [ExpenseCategoryController::class, 'index']);
...
$routes->get('expenses/categories/edit/(:num)', [ExpenseCategoryController::class, 'edit/$1']);
...
$routes->get('expenses/categories/create', [ExpenseCategoryController::class, 'edit']);
